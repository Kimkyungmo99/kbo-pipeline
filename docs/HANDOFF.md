...
8. 그 다음: GitHub Actions 일일 스케줄(오전 8시) + 실패 알림. 새 시즌마다 `SEASON_OPENING` 등록.
9. 문서 후속: ADR 002 개정 2(시즌 간 규정 변화가 검증 빈도에 나타난 사례), ADR 003에 exhibition·SEASON_OPENING 보강, 면접 문답 Q9(시즌별 변화율 조기 경보)·Q10(규모가 커져야 드러나는 운영 결함 — 1,009번째 파일).
